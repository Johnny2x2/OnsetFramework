...
function OnPackageStart()
    ...
    LoadWebFile(HungerFoodHud, "http://asset/OnsetFramework/hud/hunger/hunger.html")
    ...
    LoadWebFile(ThirstHud, "http://asset/OnsetFramework/hud/thirst/thirst.html")
	...
	LoadWebFile(HealthHud, "http://asset/OnsetFramework/hud/health/health.html")
    ...
    LoadWebFile( SpeakingHud, "http://asset/OnsetFramework/hud/speaking/hud.html" )
    ...
    SetWebURL(minimap, "http://asset/OnsetFramework/hud/minimap/minimap.html")
